...
public class UsedAgain {
	// Define a counter
	public static enum Counter{
		RECORD_COUNT
	}

  public static class UsedAgainMapper
    ...
    public void map(Object key, Text value, Context context
      ...
      try{
    	  String taskType = fields[6].trim();
    	  String usedAgain = fields[9].trim();
    	  
    	  outKey.set(taskType + "|" + usedAgain);
  ...
  public static class UsedAgainReducer
  ...
  public static void main(String[] args) throws Exception {
	  ...
	  job.setJarByClass(UsedAgain.class);
	  job.setMapperClass(UsedAgainMapper.class);
	  job.setCombinerClass(UsedAgainReducer.class);
	  job.setReducerClass(UsedAgainReducer.class);
